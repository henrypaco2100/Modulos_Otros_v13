...
class EsiProductionReportWizard(models.TransientModel):
    ...
    def action_export_excel(self):
        ...
        if data['report_type'] == 'materials':
            ...
            columns = ['Producto', 'UDM', '# OF', 'Producido', 'Costo Material', 'Costo Operación', 'Costo Total', 'Costo/UD', 'PVP Lista', 'Valor Potencial', 'Margen Potencial', 'Margen %']
        else:
